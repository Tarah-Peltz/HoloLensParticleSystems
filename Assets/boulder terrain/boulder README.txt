...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=boulder&box=-105.246805,40.051453,-105.340689,39.979588
...
-----------
  ...
  * boulder Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * boulder Height Map (SRTM30 Plus).png
  ...
  * boulder Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 1591m (actual) is equal to 40m in
